...
export function Navbar() {
  ...
  return <header className="nav-wrap"><nav className="nav shell" aria-label="Primary navigation">
    <a href="#home" className="brand brand-identity" aria-label="Mohamed home"><span className="brand-monogram" aria-hidden="true"><i/><i/><i/></span><span className="brand-copy"><b>Mohamed<span className="brand-dot">.</span></b><small>FULL STACK DEVELOPER</small></span></a>
